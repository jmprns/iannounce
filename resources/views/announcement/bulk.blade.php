...
<div class="row">
    <div class="col-sm-12">
        <div id="announce-form-whirl" class="card-box table-responsive">
            <h4 class="m-t-0 header-title"><b>Announce to Many</b></h4>
            ...
            <form id="announce-form" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                       <select id="announce-target" class="dept-year form-control select2-multiple" multiple="multiple" multiple data-placeholder="Choose Subscriber...">
                            @foreach($subscribers as $subscriber)
                                <option value="{{ $subscriber->id }}">{{ $subscriber->lname }}, {{ $subscriber->fname }} - {{ $subscriber->number }}</option>
                            @endforeach                        
                        </select>
                    </div>
                </div>
